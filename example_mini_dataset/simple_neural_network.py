...
# You should use cuda if you have external graphic card
...
# Specify the main storage location of EEG data
base_path = "MINI_DATASET"
model_save_path = "example_mini_dataset/mini_dataset_model.pth"
...
# The results are not good it is just for simplicity how to use it