...
SNR = 3
MODELS_OUTPUT_NAME = f"epileptics_simulated_SNR_{SNR}_and_healthy_real"
MODELS_OUTPUT_PATH = Path("models") / MODELS_OUTPUT_NAME
PLOTS_OUTPUT_FOLDER = (
    Path("diplomka") / "plots3_diskuze" / f"epileptics_simulated_SNR_{SNR}_and_healthy_real"
)
...
for fold_idx, (train_patients, test_patients) in enumerate(cv_splits):
    ...
    healthy_real = NNControl.get_patient_ids_by_type(
